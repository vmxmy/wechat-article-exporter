...
export type MessageCatalog = {
  ...
  readonly actions: { readonly title: string; readonly description: string; readonly preview: string; readonly previewUnavailable: string; readonly previewBlocked: string; readonly download: string; readonly metadata: string; readonly comments: string; readonly resources: string; readonly forceResources: string; readonly resourcesSummaryTitle: string; readonly resourcesSummary: (total: number, available: number, missing: number) => string; readonly resourcesComplete: string; readonly resourcesLoading: string; readonly resourcesUnavailable: string; readonly failed: string; readonly saveQuery: string; readonly exportSelected: string; readonly exportMatching: string }
  }
  readonly resources: {
    readonly accounts: AccountResourceMessages
    readonly albums: ResourceMessages & { readonly actions: { readonly title: string; readonly description: string; readonly traverse: string; readonly download: string; readonly export: string; readonly selectOne: string; readonly queued: (id: string) => string; readonly failed: string } }
...
type AccountResourceMessages = ResourceMessages & {
  readonly actions: { readonly title: string; readonly description: string; readonly search: string; readonly fakeid: string; readonly name: string; readonly alias: string; readonly discover: string; readonly add: string; readonly edit: string; readonly remove: string; readonly sync: string; readonly downloadManifest: string; readonly importManifest: string; readonly manifestHint: string; readonly manifestImported: (added: number, merged: number, unchanged: number) => string; readonly manifestFailed: string; readonly selectOne: string; readonly deleteTitle: string; readonly deleteConfirm: string; readonly confirmDelete: string; readonly cancelDelete: string; readonly actionFailed: string }
}

type JobResourceMessages = ResourceMessages & {
  readonly actions: { readonly title: string; readonly description: string; readonly start: string; readonly pause: string; readonly resume: string; readonly retry: string; readonly cancel: string; readonly selectOne: string; readonly pauseTitle: string; readonly retryTitle: string; readonly cancelTitle: string; readonly confirmPause: string; readonly confirmRetry: string; readonly confirmCancel: string; readonly cancelConfirmation: string; readonly actionFailed: string }
...
type SavedQueryResourceMessages = ResourceMessages & {
  readonly actions: { readonly title: string; readonly description: string; readonly name: string; readonly query: string; readonly create: string; readonly edit: string; readonly remove: string; readonly selectOne: string; readonly invalidQuery: string; readonly deleteTitle: string; readonly deleteConfirm: (name: string) => string; readonly confirmDelete: string; readonly cancelDelete: string; readonly saved: (name: string) => string; readonly editing: (name: string) => string; readonly deleted: (name: string) => string; readonly actionFailed: string }
}
