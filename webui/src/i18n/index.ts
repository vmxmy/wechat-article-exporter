...
type AccountResourceMessages = ResourceMessages & {
  readonly actions: { readonly title: string; readonly description: string; readonly search: string; readonly fakeid: string; readonly name: string; readonly alias: string; readonly discover: string; readonly discoveryResults: string; readonly discoveryEmpty: string; readonly useCandidate: string; readonly candidateSelected: (name: string) => string; readonly add: string; readonly saved: (name: string) => string; readonly edit: string; readonly remove: string; readonly sync: string; readonly syncMode: string; readonly incremental: string; readonly full: string; readonly incrementalHint: string; readonly fullHint: string; readonly downloadManifest: string; readonly importManifest: string; readonly manifestHint: string; readonly manifestImported: (added: number, merged: number, unchanged: number) => string; readonly manifestFailed: string; readonly selectOne: string; readonly deleteTitle: string; readonly deleteConfirm: string; readonly deleteConfirmation: (ids: readonly string[]) => string; readonly deleteConfirmationLabel: string; readonly deleteConfirmationHint: string; readonly confirmDelete: string; readonly cancelDelete: string; readonly actionFailed: string }
}
