...
export type MessageCatalog = {
  ...
  readonly login: { readonly title: string; readonly description: string; readonly legacyDescription: string; readonly manageGlobally: string; readonly sessionTitle: string; readonly sessionMenu: string; readonly signedOut: string; readonly accountUnavailable: string; readonly manageSession: string; readonly account: string; readonly state: string; readonly unknownState: string; readonly checking: string; readonly unavailable: string; readonly qrTitle: string; readonly qrDescription: string; readonly qrSignedIn: string; readonly start: string; readonly poll: string; readonly complete: string; readonly logout: string; readonly logoutComplete: string; readonly logoutUnavailable: string; readonly logoutConfirmTitle: string; readonly logoutConfirmDescription: string; readonly logoutConfirmCancel: string; readonly retry: string; readonly switchTitle: string; readonly switchAccount: string; readonly switchChecking: string; readonly switchEmpty: string; readonly switchUnavailable: string; readonly switching: string; readonly switchComplete: (name: string) => string; readonly workspaceExpiredTitle: string; readonly workspaceExpiredDescription: string; readonly workspaceExpiredBadge: string; readonly progressTitle: string; readonly stepGenerate: string; readonly stepScan: string; readonly stepConfirm: string; readonly stepFinish: string; readonly statusIdle: string; readonly statusStarting: string; readonly statusWaiting: string; readonly statusScanned: string; readonly statusConfirmed: string; readonly statusCompleted: string; readonly statusExpired: string; readonly statusFailed: string; readonly autoRefresh: string; readonly lastChecked: (time: string) => string; readonly logTitle: string; readonly states: Readonly<Record<string, string>> }
  ...
  readonly articles: {
    ...
    readonly filters: { readonly title: string; readonly advanced: string; readonly advancedHint: string; readonly invalid: string; readonly reset: string; readonly accountId: string; readonly albumId: string; readonly author: string; readonly state: string; readonly messageTypes: string; readonly hasContent: string; readonly hasComments: string; readonly deleted: string; readonly original: string; readonly paid: string; readonly any: string; readonly yes: string; readonly no: string; readonly publishedFrom: string; readonly publishedTo: string; readonly readMin: string; readonly readMax: string; readonly oldLikeMin: string; readonly oldLikeMax: string; readonly shareMin: string; readonly shareMax: string; readonly likeMin: string; readonly likeMax: string; readonly commentMin: string; readonly commentMax: string; readonly weCoinMin: string; readonly weCoinMax: string; readonly mediaSecondsMin: string; readonly mediaSecondsMax: string; readonly rangeFrom: string; readonly rangeTo: string; readonly rangeReads: string; readonly rangeOldLikes: string; readonly rangeLikes: string; readonly rangeShares: string; readonly rangeComments: string; readonly rangeWeCoin: string; readonly rangeMediaSeconds: string }
    readonly ux: {
...
type SettingsMessages = {
  ...
  readonly navigation: { readonly label: string; readonly general: string; readonly downloadExport: string; readonly credentials: string; readonly network: string; readonly storage: string; readonly diagnostics: string }
...
type JobResourceMessages = ResourceMessages & {
  ...
  readonly filters: { readonly kind: string; readonly allKinds: string; readonly clearKind: string; readonly appliedFilters: string; readonly clearFilters: string; readonly removeFilter: (label: string) => string }
  readonly progress: { readonly label: (task: string) => string; readonly ratio: (done: number, total: number) => string; readonly ratioText: (done: number, total: number) => string; readonly unknownTotal: (done: number) => string; readonly noItems: string; readonly state: (count: number, label: string) => string }
  readonly timing: { readonly notStarted: string; readonly stillRunning: string; readonly elapsed: (duration: string) => string; readonly waiting: (duration: string) => string; readonly queueWait: string; readonly runTime: string; readonly completedAt: string }
  readonly attention: { readonly blockedTitle: (count: number) => string; readonly blockedSignIn: string; readonly blockedHint: string; readonly failedItems: (count: number) => string; readonly occurredAt: string; readonly errorMessage: string }
  readonly emptyState: { readonly firstUseTitle: string; readonly firstUseDescription: string; readonly filteredEmptyTitle: string; readonly filteredEmptyDescription: string; readonly filteredEmptyAction: string }
  ...
  readonly detail: { readonly title: string; readonly description: string; readonly refresh: string; readonly refreshing: string; readonly loading: string; readonly unavailable: string; readonly items: string; readonly itemsLimited: (shown: number, total: number) => string; readonly noItems: string; readonly logs: string; readonly noLogs: string; readonly lease: string; readonly leaseActive: string; readonly leaseInactive: string; readonly expires: string; readonly attempts: string; readonly errorClass: string; readonly refreshed: string; readonly attention: string; readonly reason: string; readonly impact: string; readonly nextAction: string; readonly retryAction: string; readonly refreshAction: string; readonly signInAction: string; readonly rateLimitAction: string; readonly timeline: string; readonly progress: string; readonly networkReason: string; readonly authReason: string; readonly rateLimitReason: string; readonly storageReason: string; readonly timeoutReason: string; readonly deletedReason: string; readonly parsingReason: string; readonly unknownReason: string; readonly itemNotCompleted: string; readonly technicalDetails: string; readonly jobID: string; readonly profile: string; readonly copyID: string; readonly copyValue: string }
}
