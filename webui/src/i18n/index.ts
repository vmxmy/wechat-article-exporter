...
type SettingsMessages = {
  ...
  readonly backups: { readonly title: string; readonly description: string; readonly create: string; readonly created: string; readonly verify: string; readonly backupId: string; readonly valid: string; readonly invalid: string; readonly restoreTitle: string; readonly restoreUnsupported: string }
