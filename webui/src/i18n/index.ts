...
type SettingsMessages = {
  ...
  readonly credentials: { readonly title: string; readonly description: string; readonly empty: string; readonly import: string; readonly remove: string; readonly nickname: string; readonly cookie: string; readonly optional: string; readonly imported: string; readonly file: string; readonly fileHint: string; readonly fileImported: string; readonly columns: { readonly account: string; readonly kind: string; readonly status: string; readonly updated: string } }
