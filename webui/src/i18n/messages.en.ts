export const en = {
  ...
  resources: {
    ...
    jobs: {
      ...
      actions: { title: 'Task controls', description: 'Pause, resume, retry, or cancel one selected persistent task.', start: 'Start task', pause: 'Pause selected task', resume: 'Resume selected task', retry: 'Retry selected task', cancel: 'Cancel selected task', selectOne: 'Select exactly one task first.', pauseTitle: 'Pause selected task', retryTitle: 'Retry selected task', cancelTitle: 'Cancel selected task', confirmPause: 'Pause this task? The existing exact confirmation is sent only for this selected task.', confirmRetry: 'Retry this task? The existing exact confirmation is sent only for this selected task.', confirmCancel: 'Cancel this task? This may interrupt local work. The existing exact confirmation is sent only for this selected task.', cancelConfirmation: 'Keep task running', actionFailed: 'The task action could not be completed.' },
