export const zhCN = {
  ...
  resources: {
    ...
    albums: {
      ...
      actions: { title: '专辑操作', description: '遍历由共享持久化专辑任务可恢复地执行；批量下载会在遍历提交后创建文章下载任务。', traverse: '遍历所选专辑', download: '遍历并批量下载', export: '导出所选专辑', selectOne: '请先选择一个带所属账号的已保存专辑。', queued: (id: string) => `专辑任务 ${id} 已排队。`, failed: '无法为专辑创建任务。' }
    },
    jobs: {
      title: '任务',
