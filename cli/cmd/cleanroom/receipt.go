...
var workflowContracts = []workflowContract{
	...
	{ID: "ui.browser-workspace", Phase: phaseOffline, Evidence: evidence(equalField("listener", evidenceText, "ipv4-loopback-random"), equalField("embeddedAssets", evidenceBoolean, "true"), equalField("sessionBootstrap", evidenceBoolean, "true"), equalField("securityHeaders", evidenceBoolean, "true"), equalField("representativeOperation", evidenceBoolean, "true"))},
